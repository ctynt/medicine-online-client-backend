...
public class CategoryController {
    ...
    public Result<List<CategoryVO>> getCategoryListByParentId(@RequestParam(required = false) Integer parentId) {
        return Result.ok(categoryService.getCategoryListByParentId(parentId));
    }
